...
<div class="container">
    ...
    <details>
        ...
        <p>The Smart Classroom integrates IoT and AI technologies to create an intelligent learning environment. This project automates tasks such as attendance, lighting, and engagement monitoring, improving efficiency and student interaction.</p>
    </details>
   <hr>
    <details>
